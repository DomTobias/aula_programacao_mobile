...
// 🔹 Substitua por seus dados do Supabase
const supabaseUrl = "https://mvoonxohkzuvmiipsnxf.supabase.co";
const supabaseAnonKey = "SUA-CHAVE-ANON"; // ⚠️ Copie do painel: Settings > API
